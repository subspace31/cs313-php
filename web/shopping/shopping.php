...
<body>    
    ...
    <div class="container free-bird">
        <div class="col-md-12 col-lg-12 mx-auto float-none white z-depth-1 p-3">
            ...
            <ul class="list-unstyled card p-3">
                <li class="media">
                    <img class="d-flex mr-3 hoverable" src="../img/so3-fayt-leingod.jpg" alt="Fayt Leingod">
                    <div class="media-body">
                        <ul>
                            ...
                            <li><br></li>
                            <li class="d-flex flex-row-reverse"><h5 class="px-2"><strong>$<span>12.15</span></strong></h5></li>
                            <li></li>
                            <li>
                                <div class="d-flex flex-row-reverse btn-group">
                                    <button class="btn btn-lg blue" onclick="addCart('Fayt Leingod', 12.15, '../img/so3-fayt-leingod.jpg', 1);" type="button">Add to Cart</button>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="media">
                    <div class="media-body">
                        <ul>
                            ...
                            <li><br></li>
                            <li class="d-flex flex-row"><h5 class="px-2"><strong>$12.25</strong></h5></li>
                            <li></li>
                            <li>
                                <div class="d-flex flex-row btn-group">
                                    <button class="btn btn-lg blue" onclick="addCart('Cliff Fittir', 12.25, '../img/so3-cliff-fittir.jpg', 2);" type="button">Add to Cart</button>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <ul class="list-unstyled card p-3">
                <li class="media">
                    <img class="d-flex mr-3 hoverable" src="../img/so3-sophia-esteed.jpg" alt="Sophia Esteed">
                    <div class="media-body">
                        <ul>
                            ...
                            <li>
                                <div class="d-flex flex-row-reverse btn-group">
                                    <button class="btn btn-lg blue" onclick="addCart('Sophia Esteed', 12.02, '../img/so3-sophia-esteed.jpg', 3);" type="button" >Add to Cart</button>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="media">
                    <div class="media-body">
                        <ul>
                            ...
                            <li>
                                <div class="d-flex flex-row btn-group">
                                    <button class="btn btn-lg blue" onclick="addCart('Peppita Rossetti', 12.08, '../img/so3-peppita-rossetti.jpg', 4);" type="button">Add to Cart</button>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="media-right">
                        <img class="d-flex mr-3 hoverable" src="../img/so3-peppita-rossetti.jpg" alt="Peppita Rossetti">
                    </div>
                </li>
            </ul>
            <ul class="list-unstyled card p-3">
                <li class="media">
                    <img class="d-flex mr-3 hoverable" src="../img/so3-nel-zelpher.jpg" alt="Nel Zypher">
                    <div class="media-body">
                        <ul>
                            ...
                            <li>
                                <div class="d-flex flex-row-reverse btn-group">
                                    <button class="btn btn-lg blue" onclick="addCart('Nel Zypher', 12.75, '../img/so3-nel-zelpher.jpg', 5);" type="button">Add to Cart</button>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="media">
                    <div class="media-body">
                        <ul>
                            ...
                            <li>
                                <div class="d-flex flex-row btn-group">
                                    <button class="btn btn-lg blue" onclick="addCart('Albel Nox', 12.20, '../img/so3-albel-nox.jpg', 6);" type="button">Add to Cart</button>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="media-right">
                        <img class="d-flex mr-3 hoverable" src="../img/so3-albel-nox.jpg" alt="Albel Nox">
                    </div>
                </li>
            </ul>
        </div>
    ...
    <aside>
            <div class="shopping-cart">
                <a href="cart.php" class="btn btn-lg blue"><i class="fa fa-cart-plus fa-3x"></i></a>
