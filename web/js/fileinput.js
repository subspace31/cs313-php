...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeClass: 'btn btn-xs btn-default px-3',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="fa fa-upload text-info"></i>',
                    uploadClass: 'btn btn-xs btn-default px-3',
                    uploadTitle: 'Upload file',
                    zoomIcon: '<i class="fa fa-search-plus"></i>',
                    zoomClass: 'btn btn-xs btn-default px-3',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: {
            prev: 'btn btn-navigate btn-sm px-3',
            next: 'btn btn-navigate btn-sm px-3',
            toggleheader: 'btn btn-default btn-sm btn-header-toggle px-3',
            fullscreen: 'btn btn-default btn-sm px-3',
            borderless: 'btn btn-default btn-sm px-3',
            close: 'btn btn-default btn-sm px-3'
        },
        ...
        previewFileIconClass: 'file-other-icon px-3',
        previewFileIconSettings: {},
        previewFileExtSettings: {},
        buttonLabelClass: 'hidden-xs',
        browseIcon: '<i class="fa fa-folder-open"></i>&nbsp;',
        browseClass: 'btn btn-primary px-3',
        removeIcon: '<i class="fa fa-trash"></i>',
        removeClass: 'btn btn-default px-3',
        cancelIcon: '<i class="fa fa-ban-circle"></i>',
        cancelClass: 'btn btn-default px-3',
        uploadIcon: '<i class="fa fa-upload"></i>',
        uploadClass: 'btn btn-default px-3',
        uploadUrl: null,
        uploadAsync: true,
        uploadExtraData: {},
        zoomModalHeight: 480,
        ...
        msgValidationErrorIcon: '<i class="fa fa-exclamation-sign px-1"></i> ',
        msgErrorClass: 'file-error-message px-3',
